...
All notable release-facing changes for this repository should be documented here.

## [Unreleased]

### Added

- Release checklist documenting prerelease vs stable-release gates
- GitHub release workflow to attach source, wheel, and SHA256 assets to published releases
- GitHub release-note configuration for better autogenerated notes

### Changed

- README now makes the research-only / prerelease release posture explicit
