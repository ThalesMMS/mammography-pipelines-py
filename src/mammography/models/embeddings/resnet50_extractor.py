"""
ResNet-50 embedding extractor for mammography feature extraction.

This module provides ResNet-50-based feature extraction capabilities for
...
Educational Context:
- ResNet-50 provides strong visual feature representations from ImageNet
...
class ResNet50Extractor:
    """
    ResNet-50 feature extractor for mammography images.

    This class provides methods for extracting 2048-dimensional feature vectors
    from mammography images using a pre-trained ResNet-50 model. It includes
    input adapters for handling grayscale images and batch processing capabilities.

    Educational Notes:
    - ResNet-50 avgpool layer provides 2048-dimensional features
    ...
    def __init__(self, config: Dict[str, Any]):
        """
        Initialize ResNet-50 extractor with configuration.
        ...
        logger.info(f"Initialized ResNet50Extractor with device: {self.device}")
    ...
    def _validate_config(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if model_name not in ['resnet50', 'resnet34', 'resnet18']:
    ...
    def _initialize_model(self) -> nn.Module:
        ...
        Educational Note: This method loads a pre-trained ResNet-50 model
        and modifies it to extract features from the avgpool layer.
        
        Returns:
            nn.Module: Modified ResNet-50 model
        """
    ...
    def _modify_model_for_extraction(self, model: nn.Module) -> nn.Module:
        """
        Modify ResNet model for feature extraction.
    ...
    def _validate_tensor(self, preprocessed_tensor: PreprocessedTensor) -> bool:
        ...
        correct format for ResNet-50 feature extraction.
    ...
    def _prepare_input_tensor(self, preprocessed_tensor: PreprocessedTensor) -> Optional[torch.Tensor]:
        ...
        Educational Note: This method prepares the tensor for ResNet-50
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        # - Example: ResNet-50 (~25M params): 100MB (FP32) vs 50MB (FP16)
...
def create_resnet50_extractor(config: Dict[str, Any]) -> ResNet50Extractor:
    """
    Factory function to create a ResNet50Extractor instance.
    
    Educational Note: This factory function provides a convenient way
    to create ResNet50Extractor instances with validated configurations.
    
    Args:
        config: Configuration dictionary for feature extraction
        
    Returns:
        ResNet50Extractor: Configured ResNet50Extractor instance
    """
    return ResNet50Extractor(config)
...
def extract_single_embedding(preprocessed_tensor: PreprocessedTensor,
    ...
    extracting individual embeddings without creating an ResNet50Extractor instance.
    ...
    Returns:
        EmbeddingVector: Extracted embedding if successful, None otherwise
    """
    extractor = create_resnet50_extractor(config)
...
def extract_batch_embeddings(preprocessed_tensors: List[PreprocessedTensor],
    ...
    Educational Note: This function provides a simple interface for
    batch embedding extraction without creating an ResNet50Extractor instance.
