...
def main(argv: Sequence[str] | None = None):
    ...
    parser.add_argument("--data_dir", required=False, help="Diretório com data.csv e subdiretório images/ (atalho para testes)")
    ...
    if args.data_dir:
        ...
        if not args.csv:
            csv_candidate = data_dir / "data.csv"
            if csv_candidate.exists():
                args.csv = str(csv_candidate)
        # For test data with images/ subdirectory, we just need the CSV with image_path column
