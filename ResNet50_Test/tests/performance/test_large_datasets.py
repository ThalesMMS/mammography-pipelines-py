...
from src.io_dicom.dicom_reader import DicomReader
...
class TestMemoryOptimization:
    ...
    def test_memory_monitoring_accuracy(self):
        ...
        assert metrics["peak_memory_mb"] > 0, "Peak memory usage should be positive"
    ...
    def test_efficient_data_structures(self):
        ...
        logger.info(f"Memory efficiency improvement: {python_usage / numpy_usage:.2f}x")
